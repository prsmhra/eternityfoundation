...
<section id="health">
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center ">
                <h3 class="mt-5">Project / <span class="heading-text">Drishti</span></h3>
                <h6 class='lead'>ABOUT CATARACT RELATED BLINDNESS</h6>
                <img src="images\title-bottom.png" alt="">
            </div>
        </div>
        <div class="row margin-b">
            <div class="col-12 col-md-6">
                <p class='about-health'>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 margin-b">
                <hr class="about-divider">
                <h4>Objective of DRISHTI</h4>
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col-11">
                        <ul>
                            <li>To make awareness of eye problems among and senior citizens from the semi-urban community of all corners of Visakhapatnam.</li>
                            <li>To make reducing the number of Cataract based blindness among the senior citizens.</li>
                            <li>To make accessible the surgeries of cataract and the related problem like Pteryzium.</li>
                            <li>To promote eye donation and encourage people, especially youths.</li>
                        </ul>
                    </div>
                </div>
            </div>
